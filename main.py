...
xgboost_featureEngineered_model = load_model("xgboost_featuresEngineered.pkl")
...
def make_predictions(input_df, input_dict):
  ...
  with col1:
    ...
    st.write(f"The customer has a {avg_probablity:.2%} probability of churning.")
...
def explain_prediction(probability, input_dict, surname):
  ...
  Your machine learning model has predicted that a customer named{surname} has a {round(probability*100, 1)}% probavility of churning, based on the information provided below. 
  ...
  -If the customer has over a 40% risk of churning, generate a 3 sentence explantion of why they are at risk of churning.
  -If the customer has less than a 40% risk of churning, generate a 3 sentence explantion of why they might not be at risk of churning.
...
def generate_email(probability, input_dict, explanation, surname):
  prompt = f""" You are a manager at HS Bank. You are responsible for ensuring customers stay with the bank and are incentivized to stay with the bank and are incentivized with various offers.

  You noticed a customer named {surname} has a {round(probability*100, 1)}% probavility of churning.

  Here is the customer's information:
  {input_dict}

  Here is some explanation of why the customer might not be at risk of churning:
  {explanation}
  ...
  Make sure to list out the a set of incentives to stay based on their information, in bullet point format. Don't ever mention the probability of churning, or the machine learning model to the customer.
  """
...
st.title("Customer Churn Precdiction")
...
if selected_customer_option:
  ...
  explantion = explain_prediction(avg_probability, input_dict, selected_customer['Surname'])
  ...
  email = generate_email(avg_probability, input_dict, explantion, selected_customer['Surname'])
